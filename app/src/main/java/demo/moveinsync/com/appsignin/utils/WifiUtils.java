package demo.moveinsync.com.appsignin.utils;
 ...
 */
    ...
    public static boolean isShareThemSSID(String ssid) {
        ...
        boolean isSharedThemSSID = names.length == 3 && names[1].equals(SENDER_WIFI_NAMING_SALT);
        Log.d(TAG, ssid+" isShareThemSSID:"+isSharedThemSSID);
        return isSharedThemSSID;
    }
    ...
    public static boolean isOpenWifi(ScanResult result) {
        boolean isWifiOpen = !result.capabilities.contains("WEP") && !result.capabilities.contains("PSK") && !result.capabilities.contains("EAP");
        Log.d(TAG, "wifi "+result.SSID+" isOpen:"+isWifiOpen);
        return isWifiOpen;
    }
