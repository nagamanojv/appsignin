...
import static demo.moveinsync.com.appsignin.SHAREthemService.ShareIntents.SHARE_CLIENT_IP;
import static demo.moveinsync.com.appsignin.SHAREthemService.ShareIntents.SHARE_SERVER_UPDATES_INTENT_ACTION;
import static demo.moveinsync.com.appsignin.SHAREthemService.ShareIntents.SHARE_SERVER_UPDATE_FILE_NAME;
import static demo.moveinsync.com.appsignin.SHAREthemService.ShareIntents.SHARE_SERVER_UPDATE_TEXT;
import static demo.moveinsync.com.appsignin.SHAREthemService.ShareIntents.SHARE_TRANSFER_PROGRESS;
import static demo.moveinsync.com.appsignin.SHAREthemService.ShareIntents.TYPE;
import static demo.moveinsync.com.appsignin.SHAREthemService.ShareIntents.Types.AP_DISABLED_ACKNOWLEDGEMENT;
import static demo.moveinsync.com.appsignin.SHAREthemService.ShareIntents.Types.FILE_TRANSFER_STATUS;
...
//                    sendAcknowledgementBroadcast(AP_ENABLED_ACKNOWLEDGEMENT);
    ...
    private void startFileHostingServer(String[] filePathsTobeServed, int port, final String sender_name) {
        m_fileServer = new SHAREthemServer(getApplicationContext()
            ...
            public synchronized void onBytesTransferProgress(final String ip, final String fileName, long totalSize, final String speed, long currentSize, final int percentage) {
                Log.e(TAG, " transfer is in progress for ip: " + ip + ", file name: " + fileName + "(percentage: " + percentage + "%)");
            ...
            public void onBytesTransferCompleted(final String ip, final String fileName) {
                Log.e(TAG, " transfer completed for ip: " + ip + ", file name: " + fileName);
            ...
            public synchronized void onBytesTransferStarted(final String ip, final String fileName) {
                Log.e(TAG, " transfer started for ip: " + ip + ", file name: " + fileName);
    ...
    private void updateForegroundNotification() {
        ...
        mNotificationManager.notify(SHARE_SERVICE_NOTIFICATION_ID, getShareThemNotification("ShareThem Wifi Hotspot Enabled", true));
    }
