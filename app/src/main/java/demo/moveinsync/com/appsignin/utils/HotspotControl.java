...
public class HotspotControl {
    ...
    /**
     * Not necessary to {@link HotspotControl} functionality but added here to help {@link } with port number to display connection URL
     */
     ...
     * @param port Port number assigned to {@link demo.moveinsync.com.appsignin.SHAREthemServer}, not used anywhere in {@link HotspotControl} but helps {@link } to display port info
